...
set(CMAKE_LINKER ${ARM_TOOLCHAIN_PATH}/${TARGET_TRIPLET}ld${TOOLCHAIN_EXT})
...
set(CMAKE_COMMON_FLAGS "-g3 -mno-unaligned-access -ffreestanding -ffunction-sections -fdata-sections -fno-strict-aliasing -fno-builtin -fno-common -Wall -Wdouble-promotion -fstack-usage")
...
set(CMAKE_EXE_LINKER_FLAGS "${LD_FLAGS} -Wl,--gc-sections,-print-memory-usage,--no-warn-rwx-segments")
