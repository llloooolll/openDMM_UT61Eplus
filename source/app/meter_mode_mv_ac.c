...
QState meter_mv_ac_adc(ao_meter_t *const me) {
    ...
    if (!me->es232_hold_flag) {
        ...
        me->es232_power_now = meter_help_mv_ac_get_power(me, me->es232_write_buffer.range_msb);
    }
 ...
 * @return int32_t
 */
static int32_t meter_help_mv_ac_cal(ao_meter_t *const me, int32_t value) { return value; }
